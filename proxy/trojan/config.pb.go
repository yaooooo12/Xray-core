...
const file_proxy_trojan_config_proto_rawDesc = "" +
	"\n" +
	"\x19proxy/trojan/config.proto\x12\x11xray.proxy.trojan\x1a\x1acommon/protocol/user.proto\x1a!common/protocol/server_spec.proto\"\xbb\x01\n" +
	"\aAccount\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\tR\bpassword\x12<\n" +
	"\x1amax_concurrent_connections\x18\x02 \x01(\x05R\x18maxConcurrentConnections\x12(\n" +
	"\x10max_upload_speed\x18\x03 \x01(\x03R\x0emaxUploadSpeed\x12,\n" +
	"\x12max_download_speed\x18\x04 \x01(\x03R\x10maxDownloadSpeed\"\x82\x01\n" +
	"\bFallback\x12\x12\n" +
