...
type Policy struct {
	...
	Limits        *Policy_Limits         `protobuf:"bytes,4,opt,name=limits,proto3" json:"limits,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Policy) GetLimits() *Policy_Limits {
	if x != nil {
		return x.Limits
	}
	return nil
...
type Policy_Limits struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Maximum number of concurrent connections for users at this level.
	// 0 means unlimited (default).
	MaxConcurrentConnections int32 `protobuf:"varint,1,opt,name=max_concurrent_connections,json=maxConcurrentConnections,proto3" json:"max_concurrent_connections,omitempty"`
	// Maximum upload speed in KB/s (kilobytes per second) for users at this level.
	// 0 means unlimited (default).
	MaxUploadSpeed int64 `protobuf:"varint,2,opt,name=max_upload_speed,json=maxUploadSpeed,proto3" json:"max_upload_speed,omitempty"`
	// Maximum download speed in KB/s (kilobytes per second) for users at this level.
	// 0 means unlimited (default).
	MaxDownloadSpeed int64 `protobuf:"varint,3,opt,name=max_download_speed,json=maxDownloadSpeed,proto3" json:"max_download_speed,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *Policy_Limits) Reset() {
	*x = Policy_Limits{}
...
func (x *Policy_Limits) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Policy_Limits) ProtoMessage() {}

func (x *Policy_Limits) ProtoReflect() protoreflect.Message {
	mi := &file_app_policy_config_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Policy_Limits.ProtoReflect.Descriptor instead.
func (*Policy_Limits) Descriptor() ([]byte, []int) {
	return file_app_policy_config_proto_rawDescGZIP(), []int{1, 3}
}

func (x *Policy_Limits) GetMaxConcurrentConnections() int32 {
	if x != nil {
...
func (x *Policy_Limits) GetMaxUploadSpeed() int64 {
	if x != nil {
...
func (x *Policy_Limits) GetMaxDownloadSpeed() int64 {
	if x != nil {
...
const file_app_policy_config_proto_rawDesc = "" +
	...
	"\x06Second\x12\x14\n" +
	"\x05value\x18\x01 \x01(\rR\x05value\"\xa0\x06\n" +
	"\x06Policy\x129\n" +
	...
	"\x06buffer\x18\x03 \x01(\v2\x1e.xray.app.policy.Policy.BufferR\x06buffer\x126\n" +
	"\x06limits\x18\x04 \x01(\v2\x1e.xray.app.policy.Policy.LimitsR\x06limits\x1a\xfa\x01\n" +
	"\aTimeout\x125\n" +
	...
	"connection\x1a\x9e\x01\n" +
	"\x06Limits\x12<\n" +
	"\x1amax_concurrent_connections\x18\x01 \x01(\x05R\x18maxConcurrentConnections\x12(\n" +
	"\x10max_upload_speed\x18\x02 \x01(\x03R\x0emaxUploadSpeed\x12,\n" +
	"\x12max_download_speed\x18\x03 \x01(\x03R\x10maxDownloadSpeed\"\xfb\x01\n" +
	"\fSystemPolicy\x129\n" +
...
var file_app_policy_config_proto_goTypes = []any{
	...
	(*Policy_Limits)(nil),      // 7: xray.app.policy.Policy.Limits
...
var file_app_policy_config_proto_depIdxs = []int32{
	...
	7,  // 3: xray.app.policy.Policy.limits:type_name -> xray.app.policy.Policy.Limits
